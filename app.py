...
def make_request(encrypt, server_name, token):
    try:
        ...
        app.logger.info(f"Request to {url} returned status: {response.status_code}")
...
def handle_requests():
    ...
    try:
        def process_request():
            ...
            if before is None:
                app.logger.error(f"Failed to retrieve initial player info for UID: {uid}, Server: {server_name}")
